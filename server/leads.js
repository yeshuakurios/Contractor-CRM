...
async function createLead({ business_name, phone, address, website, email, decision_maker }) {
  ...
  const { rows } = await pool.query(
    `INSERT INTO leads (business_name, phone, address, website, email, decision_maker)
     VALUES ($1, $2, $3, $4, $5, $6) RETURNING *`,
    [business_name.trim(), phone || null, address || null, website || null, email || null, decision_maker || null]
  );
  return rows[0];
}
